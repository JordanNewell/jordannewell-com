...
The conventional advice is wrong. It's especially wrong in 2026. At least, that's what the AI keeps telling me.
...
- `/rebuild` — build-in-public meta. Post-mortems, weekly notes, what shipped, what broke. You are here.
...
1. This post (you're here).
2. [/now](/now) — what I'm focused on this month.
3. [/projects](/projects) — what I've built.
4. [/contributions](/contributions) — OSS work I've shipped to others.
